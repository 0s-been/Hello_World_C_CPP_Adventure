...
public class PlayerComboAtk_before : MonoBehaviour
{
    [SerializeField]
    ...
    {
        //############################
        //콤보어택에서 직접 마우스 클릭을 감지하는 형태로 콤보에 대한 단일 기능이 아닌 입력에 대한 기능까지
        //담당하고 있어서 SRP에 위배되는 형태입니다.
